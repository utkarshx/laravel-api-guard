<?php namespace Utkarshx\ApiGuard\Console\Commands;

use App;
use Utkarshx\ApiGuard\Models\ApiKey;
use Config;
...
class GenerateApiKeyCommand extends Command
{
    ...
    public function fire()
    {
        ...
        $apiKey = App::make(Config::get('apiguard.model', 'Utkarshx\ApiGuard\Models\ApiKey'));
